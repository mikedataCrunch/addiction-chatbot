...
Such a closed domain is captured in the niche task of building an addiction recovery chatbot which takes answers from religious speeches.
...
![Report Preview](report-preivew.png)
